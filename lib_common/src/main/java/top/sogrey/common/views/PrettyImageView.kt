...
/**
 * 支持圆形和圆角定制化的ImageView,https://github.com/BayMikyou/PrettyImageView
 * <p/>
 *   1、支持圆角矩形图片，圆形图片<br/>
 *   2、支持border的显示以及宽度和颜色的定制化<br/>
 *   3、支持圆角矩形四个角的角度任意定制化,包括四个角，每个角的X,Y方向上大小定制化<br/>
 *   4、支持圆形右上角圆点定制化<br/>
 *
 *         <code>
                <top.sogrey.common.views.PrettyImageView
                    ...
                    app:circle_dot_color="#ff0000"
                    app:circle_dot_radius="7dp"
                    app:layout_constraintBottom_toBottomOf="parent"
                    app:layout_constraintEnd_toEndOf="parent"
                    app:layout_constraintStart_toStartOf="parent"
                    app:layout_constraintTop_toTopOf="parent"
                    app:left_bottom_radiusX="40dp"
                    app:left_bottom_radiusY="40dp"
                    app:left_top_radiusX="10dp"
                    app:left_top_radiusY="40dp"
                    app:right_bottom_radiusX="40dp"
                    app:right_bottom_radiusY="40dp"
                    app:right_top_radiusX="10dp"
                    app:right_top_radiusY="40dp"
                    app:shape_type="SHAPE_ROUND"
                    app:show_border="true"
                    app:show_circle_dot="false"/>
 *         </code>
 * <p/>
 * @author Sogrey
...
class PrettyImageView @JvmOverloads constructor(
    ...
    private fun buildRoundPath() {
        if (!mShowBorder) {
            //绘制不带边框的圆角实际上只需要把一个圆角矩形扔进path即可
            floatArrayOf(
            ...
            //绘制带边框的圆角实际上只需要把一个圆角矩形和一个圆角矩形的变量都扔进path即可
            floatArrayOf(
    ...
    /**
     * 由于经过以上根据不同逻辑构建了boderPath和shapePath,path中已经储存相应的形状，现在只需要把相应shapePath中形状用带BitmapShader画笔绘制出来,boderPath用普通画笔绘制出来即可
     */
